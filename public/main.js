...
// HACER UNA FUNCION PARA ELIMINAR LA CUENTA
...
const nombreUsuarioHeader = $('nombre-usuario-header')
// const tooltipPerfilYRegistro = $('tooltip-perfil-register')
const btnCerrarSesion = $('btn-cerrar-sesion')
const registroEnElHeader = $('btn-registrar-header')
...
function validarInput (e) {
  ...
  if ((e.key === ' ' || INPUT.value.includes(' ')) && INPUT.name !== 'numero') {
...
function actualizarPagina () {
  // esta funcion actualiza la pagian dependiendo si el usuario esta logeado
  if (USUARIO !== undefined) {
    registroEnElHeader.style.display = 'none'
    nombreUsuarioHeader.style.display = 'flex'
    nombreUsuarioHeader.innerHTML = USUARIO.nombre
    loginEnElHeader.style.display = 'none'
    btnMenu.style.display = 'flex'
  } else {
    loginEnElHeader.style.display = 'flex'
    btnMenu.style.display = 'none'
    registroEnElHeader.style.display = 'flex'
    ...
    if (verificarYAlertarInputs(inputsRegister)) {
      let usuarioRegistro = {
        ...
        configuracion: {
          ...
          musica: 'off',
          efectosDeSonidoDelTeclado: 'off',
          inicioDeSesionAutomatico: $('input-inicio-sesion-automatico-register')
            .checked
        },
...
function removerAlertaInput (input) {
  ...
  const spanAlert = ByName(nameSpanAlert)
  const contenedorPadre = ByName(namePadre)
  spanIcon.removeAttribute('id', 'icono-input-valid')
  spanIcon.className = ''
  spanIcon.style.background = 'transparent'
...
function cerrarLogin () {
  ...
  inputsRegister.forEach(input => {
    removerAlertaInput(input)
  })
  removerAlertaInput(inputContraseñaLogin)
  removerAlertaInput(inputNombreUsuarioLogin)
}
